...
/**
 * This class provides an empty implementation of {@see SayParserVisitor},
 * which can be extended to create a visitor which only needs to handle a subset
 * of the available methods.
 */
class SayParserBaseVisitor extends AbstractParseTreeVisitor implements SayParserVisitor
{
	/**
	 * {@inheritdoc}
	 *
